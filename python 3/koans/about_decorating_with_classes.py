...
class AboutDecoratingWithClasses(Koan):
    ...
    def test_partial_that_wrappers_no_args(self):
        """
        Before we can understand Class Decorators we need to consider
        the partial.
        """
    ...
    @documenter("Increments a value by one.")
    ...
    def test_decorator_with_an_argument(self):
        ...
        self.assertEqual('Increments a value by one.', self.count_badly.__doc__)
