...
class AboutLists(Koan):
    ...
    def test_slicing_lists(self):
        ...
        self.assertEqual([], noms[2:2]) # include ['and'] and exclude ['and] == []
    ...
    def test_ranges_with_steps(self):
        self.assertEqual([5, 4], list(range(5, 3, -1))) # 3rd argument == -1 == reverse order
        self.assertEqual([0, 2, 4, 6], list(range(0, 8, 2))) # if 3rd argument > 1 == hopper
        self.assertEqual([1, 4, 7], list(range(1, 8, 3)))
        self.assertEqual([5, 1, -3], list(range(5, -7, -4))) # if 3rd argument > -1 == reversed hopper
