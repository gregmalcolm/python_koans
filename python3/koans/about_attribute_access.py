...
class AboutAttributeAccess(Koan):
    ...
    def test_all_attribute_reads_are_caught(self):
        ...
        self.assertRegexpMatches(catcher.foobar, "foobar' and it could not be found")

    def test_intercepting_return_values_can_disrupt_the_call_chain(self):
        catcher = self.CatchAllAttributeReads()

        self.assertRegexpMatches(catcher.foobaz, "'foobaz' and it could not be found") # This is fine
        ...
        self.assertRegexpMatches(err_msg, 'not callable')
    ...
    def test_changes_to_the_getattribute_implementation_affects_getattr_function(self):
        ...
        self.assertRegexpMatches(getattr(catcher, 'any_attribute'), "'any_attribute' and it could")
