...
class AboutLists(Koan):
    ...
    def test_slicing_lists(self):
        ...
        self.assertEqual(['peanut', 'butter'], noms[0:1])
        self.assertEqual(['peanut', 'butter', 'and'], noms[0:2])
